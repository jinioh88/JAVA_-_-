...
public class Client {
    public static void main(String[] args) {
        ...
        ReportGenerator simpleGene = new SimpleReportGenerator();
        System.out.println(simpleGene.generate(customers));

        ReportGenerator complexGene = new ComplexReportGenerator();
        System.out.println(complexGene.generate(customers));
    }
}
